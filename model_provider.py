...
class CausalTransformerModelProvider:
    def provide_transformer(self, args, tokenizer, tie_embeddings) -> megatransformer.MegaTransformer:
        ...
        decoder_config = config.EncoderDecoderConfig(
            ...
            pre_self_attn_norm=args.pre_self_attn_norm,
            post_self_attn_norm=args.post_self_attn_norm,
            pre_ffn_norm=args.pre_ffn_norm,
            post_ffn_norm=args.post_ffn_norm,
        ...
        if bool(args.use_huginn):
            ...
            decoder_config.max_huginn_thinking_steps = args.max_huginn_thinking_steps,
