...
class MultiConvAttention(nn.Module):
    ...
    def __init__(self, args, in_decoder):
        ...
        self.pointwise = nn.Conv1d(args.d_model, args.mca_d_output, kernel_size=1)

    def forward(self, query_sequences, key_sequences):
        """
        ...
        sequences = key_sequences.transpose(1, 2) # (batch_size, d_model, query_sequence_pad_length)
