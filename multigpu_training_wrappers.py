...
class MultiGPUTranslationWrapper:
    ...
    def forward_pass(self, 
        ...
        for i, (input_ids, labels, src_key_padding_mask, tgt_key_padding_mask) in enumerate(splits):
            ...
            total_loss = outputs.loss.to(input_ids.device)
            translation_loss = outputs.main_loss.to(input_ids.device)
            ...
            # Scale losses
            scaled_loss = (total_loss) / (self.batches_per_step * self.num_gpus)
